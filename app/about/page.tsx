...
//       icon: Globe,
//       color: "blue",
//       img: "/about tradition.png"
//     },
//     // Artist card inserted between expansion and modernization
//     {
//       period: "",
...
//                 className="text-xl sm:text-2xl md:text-3xl leading-relaxed max-w-4xl mx-auto text-gray-800 font-light"
//               >
...
//                         era.isArtist ? "border-2 border-amber-200" : ""
//                       }`}
//                     >
//                       <div
...
//                       <div
//                         className={`${era.img ? "w-150 h-150" : "w-32 h-32"} rounded-full bg-gradient-to-r from-${era.color}-500 to-${era.color}-600 shadow-lg flex items-center justify-center`}
//                       >
//                         {era.img ? (
//                           <img src={era.img} alt={era.title} className="w-full rounded-[12px]"/>
//                         ) : (
...
//         {/* Maison Philosophy / Values Section */}
